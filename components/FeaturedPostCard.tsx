...
export default function FeaturedPostCard({ slug, publishedAt, title, index }) {
  return (
    <Link href={`/blog/${slug}`}>
      <div className="w-full border-b border-gray-200 dark:border-gray-700 py-3 transform hover:scale-[1.01] hover:cursor-pointer transition-all">
