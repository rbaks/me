...
Moodle works differently than any other software project, since the entire website is dynamically generated from a database at run-time - even HTML and CSS changes.
...
- [Do You Even Need a Database?](/blog/bijective-functions-applied-to-database-operations#do-you-even-need-a-database)
- [Low Code Solutions](/blog/bijective-functions-applied-to-database-operations#low-code-solutions)
- [Terms To Understand](/blog/bijective-functions-applied-to-database-operations#terms-to-understand)
  - [SQL / NoSQL](/blog/bijective-functions-applied-to-database-operations#sql--nosql)
  - [GraphQL / REST](/blog/bijective-functions-applied-to-database-operations#graphql--rest)
  - [Authentication / Authorization](/blog/bijective-functions-applied-to-database-operations#authentication--authorization)
  - [Hosted / Self-Hosted](/blog/bijective-functions-applied-to-database-operations#hosted--self-hosted)
  - [Serverless](/blog/bijective-functions-applied-to-database-operations#serverless)
  - [Data Modeling](/blog/bijective-functions-applied-to-database-operations#data-modeling)
- [Levels of Abstraction](/blog/bijective-functions-applied-to-database-operations#levels-of-abstraction)
- [List of Services](/blog/bijective-functions-applied-to-database-operations#list-of-services)
  - [Backend (as a Service)](/blog/bijective-functions-applied-to-database-operations#backend-as-a-service)
    - [Supabase](/blog/bijective-functions-applied-to-database-operations#supabase)
    - [Hasura](/blog/bijective-functions-applied-to-database-operations#hasura)
  - [Build Your Own Backend](/blog/bijective-functions-applied-to-database-operations#build-your-own-backend)
    - [Prisma](/blog/bijective-functions-applied-to-database-operations#prisma)
- [Should You Use a CMS?](/blog/bijective-functions-applied-to-database-operations#should-you-use-a-cms)
- [Starting From Scratch](/blog/bijective-functions-applied-to-database-operations#starting-from-scratch)
- [Conclusion / Resources](/blog/bijective-functions-applied-to-database-operations#conclusion--resources)
